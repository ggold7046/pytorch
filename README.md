...
- [More On PyTorch](#more-about-pytorch)
...
* Slack: The [PyTorch Slack](https://pytorch.slack.com/) hosts a primary audience of moderate- to experienced-level PyTorch users and developers for general chat, online discussions, collaboration, etc. If you are a beginner looking for help, the primary medium is the [PyTorch Forums](https://discuss.pytorch.org). If you need a slack invite, please fill out this form: https://goo.gl/forms/PP1AGvNHpSaJP8to1
